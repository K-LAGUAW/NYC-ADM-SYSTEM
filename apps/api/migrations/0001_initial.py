# Generated by Django 5.2.1 on 2025-06-21 11:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('REC', 'Recibido'), ('ENT', 'Entregado'), ('CANCELADO', 'Cancelado')], default='PENDIENTE', max_length=20, verbose_name='Estado')),
            ],
            options={
                'verbose_name': 'orden',
