    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('local_address', models.CharField(blank=True, max_length=50, null=True, verbose_name='Direccion local')),
                ...
                ('status', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='api.ordersstatus', verbose_name='Estado')),
            ],
            options={
                'verbose_name': 'orden',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='api.shipmentsstatus', verbose_name='Estado')),
            ],
            options={
                'verbose_name': 'envio',
