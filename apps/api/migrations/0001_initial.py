    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('REC', 'Recibido'), ('ENT', 'Entregado'), ('CANCELADO', 'Cancelado')], default='REC', max_length=20, verbose_name='Estado')),
                ('supplier', models.CharField(max_length=50, verbose_name='Proveedor')),
                ('local_address', models.CharField(max_length=255, verbose_name='Direccion local')),
                ...
                ('envelope_amount', models.PositiveIntegerField(verbose_name='Importe de sobre')),
                ('package_pickup', models.BooleanField(verbose_name='Recogida de paquete')),
                ('total_amount', models.PositiveIntegerField(verbose_name='Importe total')),
            ],
            options={
                'verbose_name': 'orden',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('ESO', 'En sucursal de origen'), ('ECD', 'En camino a sucursal de destino'), ('ESD', 'En sucursal de destino'), ('ENT', 'Entregado'), ('CAN', 'Cancelado')], default='ESO', max_length=20, verbose_name='Estado')),
